...
import com.patrick.spring.data.jpa.tutorial.entity.CourseMaterial;
...
class CourseMaterialRepositoryTest {
    ...
    public void saveCourseMaterial() {
        ...
        CourseMaterial courseMaterial = new CourseMaterial().builder().url("www.google.com").course(course).build();
